...
package org.jetbrains.letsPlot.raster
...
class SvgCanvasFigure(
    ...
    override fun mapToCanvas(canvasControl: CanvasControl): Registration {
        ...
        val anim = canvasControl.createAnimationTimer(object : AnimationEventHandler {
...
private fun Context2d.transform(m: Matrix33) {
    transform(
        m.scaleX.toDouble(),
        m.skewX.toDouble(),
        m.skewY.toDouble(),
