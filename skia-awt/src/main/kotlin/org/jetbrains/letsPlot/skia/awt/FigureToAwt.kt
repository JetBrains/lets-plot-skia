...
internal class FigureToAwt(
    ...
    private fun processCompositeFigure(
        ...
        val rootJComponent: JComponent = SvgPanel(svgRoot.svg, eventDispatcher = eventDispatcher)
...
//            rootJPanel.add(it)   // Do not!!!
    ...
    companion object {
        private fun buildSinglePlotComponent(
            ...
            val plotComponent: JComponent = SvgPanel(
                svg = svg,
            ...
            parentEventDispatcher?.addEventDispatcher(
                bounds = bounds!!,
                eventDispatcher = (plotComponent as SvgPanel).eventDispatcher
            )
